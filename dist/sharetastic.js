...
var _sharetastic = require('./sharetastic');

var _sharetastic2 = _interopRequireDefault(_sharetastic);
...
(function (window, $) {
    ...
    $.fn.sharetastic = function (options) {
        return this.each(function () {
            ...
            if (!isInitialized) {
                new _sharetastic2.default(element[0], options).sort();
            }
        });
    };
})(window, jQuery);

},{"./sharetastic":2}],2:[function(require,module,exports){
'use strict';
...
var Sharetastic = function () {
    ...
    _createClass(Sharetastic, [{
        ...
        value: function addSpriteToPage() {
            ...
            wrapper.innerHTML = _sprite2.default;
        ...
        value: function generateOptions(options) {
            ...
            var exportOptions = _extends(defaults, options);
...
exports.default = Sharetastic;

},{"./sprite":3}],3:[function(require,module,exports){
'use strict';
